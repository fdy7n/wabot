...
┷┯ ☾ Others Commands ☽
   ...
   ╿
   ╿
   ╰╼❥ Kirim perintah *!readme* untuk mengetahui fungsi dan cara penggunaan perintah di atas, WAJIB DIBACA!!.`
}
exports.help = help()
function readme() {
    return `
...
Source codenya disini : https://github.com/mhankbarbar/whatsapp-bot
Owner asli Bot : wa.me/6285892766102
Author         : Ada deh pokoknya

Oh iya, bot ini gratis ya, soalnya saya lihat banyak yang jual bot² kayak gini, tapi ini gratis kok.`
}
exports.info = info()
function snk() {
    return `Syarat dan Ketentuan Bot *Fuady BOT*
...
Kalo mau donate langsung ae ke owner aslinya aja yaa
